...
"[project]/app/api/auth/last-seen/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$helpers$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthFromRequest"])(request);
    if (!auth) {
    ...
    const { data: userData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('users').select('display_name').eq('id', auth.userId).single();
    const displayName = userData?.display_name || 'Usuário';
    // Atualiza last_seen na tabela users (para compatibilidade)
    const { error: usersError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('users').update({
        last_seen: now
    }).eq('id', auth.userId);
    if (usersError) {
    ...
    const { error: presenceError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('presence').upsert({
        user_id: auth.userId,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0528cf._.js.map