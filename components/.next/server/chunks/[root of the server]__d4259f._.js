...
"[project]/app/api/config/storage/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const configFilePath = __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'storage.config.json');
async function getConfig() {
    try {
        const data = await __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].readFile(configFilePath, 'utf-8');
        ...
        if (error.code === 'ENOENT') {
            ...
            await __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(configFilePath, JSON.stringify(defaultConfig, null, 2));
...
async function POST(request) {
    try {
        ...
        if (typeof useFirebase !== 'boolean') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid value for useFirebase'
            }, {
                status: 400
            });
        }
        ...
        await __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(configFilePath, JSON.stringify(newConfig, null, 2));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d4259f._.js.map